const ProblemSection = () => {
    return (
        <section className="relative max-w-5xl mx-auto py-4 px-4 md:px-8 mt-8 lg:mt-16">
            <div className="absolute top-0 left-0 w-full h-full"></div>
            <div className="relative z-10 gap-5 items-center lg:flex">
                <div className="flex-1 max-w-5xl py-5 sm:mx-auto sm:text-center lg:max-w-max lg:text-left">
                    <h3 className="text-3xl font-semibold md:text-4xl">
                        The government is printing money <span className="text-transparent bg-clip-text bg-blue-600">like never before.</span>
                    </h3>
